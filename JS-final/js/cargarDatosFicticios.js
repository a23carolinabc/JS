function cargarTicketsFicticios() {
    ...
    let ticketsCombinados = [...ticketsExistentes];

    // Combinar tickets existentes y nuevos si no hay tickets guardados
    if (ticketsExistentes.length == 0) {
        ticketsCombinados = [...ticketsExistentes, ...nuevosTickets];    
    }
